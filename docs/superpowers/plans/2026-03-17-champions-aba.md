...
**Goal:** Restaurar a app e entregar aba dedicada de campeoes usando o motor `buildChampionsRanking`.
...
- [ ] **Step 2: Adicionar navegação entre `Sorteios` e `Campeoes`**
- [ ] **Step 3: Manter render e filtros existentes de sorteios**

### Task 2: Integrar ranking de campeoes

**Files:**
- Modify: `web/src/main.js`
- Use: `web/src/champions.js`

- [ ] **Step 1: Adicionar controles da aba (N, pesos, Top N)**
- [ ] **Step 2: Calcular ranking com `buildChampionsRanking`**
- [ ] **Step 3: Renderizar tabela de campeoes e estado vazio**
